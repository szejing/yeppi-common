import type { CustomerInsightCategory, CustomerInsightConfidence, CustomerInsightKey, CustomerInsightSeverity, CustomerInsightSource } from '../enum/customer-insight';
