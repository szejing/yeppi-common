...
export function isMerchantIdParam(value) {
    return MERCHANT_ID_SHAPE.test(String(value ?? '').trim().toLowerCase());
}
export function slugifyToStoreHandle(value) {
...
export function allocateStoreHandle(name, taken) {
...
export function validateStoreHandle(value) {
...
export function merchantStorePath(handle) {
    return `/merchants/${encodeURIComponent(handle)}`;
}
export function merchantStoreProductPath(handle, productSegment) {
