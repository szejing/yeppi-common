 ...
 * @returns The truncated string
 */
export const truncateFront = (str, maxLength) => {
    if (str.length <= maxLength) {
        return str;
    }
 ...
 */
export const extractAfterSeparator = (str, separator) => {
 ...
 */
export const extractBeforeSeparator = (str, separator) => {
    const parts = str.split(separator);
 ...
 */
export const removeMerchantId = (str) => {
