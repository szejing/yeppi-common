...
const MALAYSIA_STATE_TO_SUBDIVISION: Record<MalaysiaState, string> = {
	Johor: 'MY-01',
	Kedah: 'MY-02',
	Kelantan: 'MY-03',
	Melaka: 'MY-04',
...
const MALAYSIA_SUBDIVISION_ALIASES: Record<string, string> = {
	...MALAYSIA_STATE_TO_SUBDIVISION,
	Malacca: 'MY-04',
	Penang: 'MY-07',
};

export function resolveMalaysiaSubdivisionCode(state: string): string {
